...
?>
        ...
        <?php if (AmpConfig::get('custom_text_footer')) {
            ...
            <a id="ampache_link" href="https://github.com/ampache/ampache#readme" target="_blank" title="<?php echo T_('Copyright'); ?> 息 2001 - 2022 Ampache.org"><?php echo T_('Ampache') . ' ' . AmpConfig::get('version'); ?></a>
        <?php } ?>
        </div>
